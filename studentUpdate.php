...
$Alumini =$row["alumini"];
if($Alumini==true)header('Location: alumini_update.php');
  ...
  if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $stmt = $pdo->prepare("
      UPDATE studentDetails
       SET Comp_name=:company,package=:salary,role=:role
       WHERE roll='$roll'
...
<form method="post">
  <label for="name">Name:</label>
      ...
      <input type="text" id="age" name="age" value="<?php echo $student['age']; ?>" readonly>

      <label for="roll">Roll Number:</label>
      <input type="text" id="roll" name="roll" value="<?php echo $student['roll']; ?>" readonly>
      ...
      <input type="text" id="batch_year" name="batch_year" value="<?php echo $student['batch_year']; ?>" readonly>

      
 <label for="Company">Company :</label>
 <input type="text" id="company" name="company" value="<?php echo $student['Comp_name']; ?>" >
 <label for="Package">Package : (*provide package in LPA) <br>(*if not placed leave empty)</label>
 <input type="number" id="package" name="package" value="<?php echo $student['package']; ?>">
