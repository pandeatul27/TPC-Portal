...
if(!isset($_SESSION['sess_user'])){
	...
	$name = $row["name"];
	$Alumini =$row["alumini"];
	if($Alumini==true)header('Location: alumini.php');
...
?>
	...
	<div>
		...
		<div id = 'nnn' style='display:none;'>
			...
			<h3>If not registered for placements click on 
				
				<button><a href="http://localhost/minpro/studentUpload.php">Register</a></button>
			</h3>
		</div>
	</div>
</body>
